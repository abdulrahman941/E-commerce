  ...
  <div className="container mx-auto my-12 w-[60%] bg-gray-100 rounded-md py-5">
    <h1 className='text-green-600 text-3xl text-center'>Verify Reset Code</h1>
      ...
      <FieldGroup>
        ...
        <Field>
          <FieldLabel htmlFor="email">newPassword:</FieldLabel>
          <Input {...form.register('newPassword')} id="newPassword" type={showPassword?"text":"password"} placeholder="enter the password" />
          {form.formState.errors.newPassword && <p className="text-red-500">{form.formState.errors.newPassword.message}</p>}
        </Field>
      </FieldGroup>
    </FieldSet>
      </div>
